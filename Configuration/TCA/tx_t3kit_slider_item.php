...
return [
    ...
    'palettes' => [
        ...
        'visibility' => [
            'showitem' => '
                hidden;LLL:EXT:t3kit/Resources/Private/Language/locallang_BE_CE_static.xlf:slider.sliderItem
            '
        ],
    ...
    'columns' => [
        'tt_content' => [
            'exclude' => true,
            'label' => 'LLL:EXT:t3kit/Resources/Private/Language/locallang_BE_CE_static.xlf:sliderItem.tt_content',
            'config' => [
                'type' => 'select',
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' =>
                    'AND tx_t3kit_slider_item=###CURRENT_PID### AND tx_t3kit_slider_item.sys_language_uid IN (-1,0)',
                'default' => 0
            ]
        ],
        'l10n_diffsource' => [
        ...
        'header' => [
            'exclude' => true,
            'label' => 'LLL:EXT:t3kit/Resources/Private/Language/locallang_BE_CE_static.xlf:sliderItem.header',
            'config' => [
                'type' => 'input',
                'size' => 50,
                'eval' => 'trim'
        ...
        'bodytext' => [
            'label' => 'LLL:EXT:t3kit/Resources/Private/Language/locallang_BE_CE_static.xlf:sliderItem.text',
        ...
        'image' => [
            'exclude' => true,
            'label' => 'LLL:EXT:t3kit/Resources/Private/Language/locallang_BE_CE_static.xlf:sliderItem.image',
